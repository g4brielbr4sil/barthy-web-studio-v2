...
const checks = [
  ...
  ['fallback mobile reposiciona a forma azul', sources.motion.includes('112vw')],
  ['fallback mobile reposiciona a forma gelo', sources.motion.includes('122vw')],
  ['fallback mobile reposiciona a forma terra', sources.motion.includes('108vw')],
  ['fallback mobile reposiciona a forma branca', sources.motion.includes('92vw')],
  [
    'fallback mobile não diverge da coreografia desktop',
    !/hero-mobile-/.test(sources.motion),
  ],
