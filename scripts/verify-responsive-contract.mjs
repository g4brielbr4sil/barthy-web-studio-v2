...
const files = {
  ...
  heroStyles: 'src/styles/components/hero.css',
  indexStyles: 'src/index.css',
...
const checks = [
  ...
  ['fallback mobile usa trajetória azul principal', sources.heroStyles.includes('animation-name: hero-organic-blue')],
  ['fallback mobile usa trajetória gelo principal', sources.heroStyles.includes('animation-name: hero-organic-ice')],
  ['fallback mobile usa trajetória Terra principal', sources.heroStyles.includes('animation-name: hero-organic-terra')],
  ['fallback mobile usa trajetória branca principal', sources.heroStyles.includes('animation-name: hero-organic-white')],
  ['camada de recovery removida', !sources.indexStyles.includes('recovery.css')],
