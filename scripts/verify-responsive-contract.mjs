...
const checks = [
  ...
  ['fallback mobile usa trajetória azul principal', sources.motion.includes('animation-name: hero-organic-blue')],
  ['fallback mobile usa trajetória gelo principal', sources.motion.includes('animation-name: hero-organic-ice')],
  ['fallback mobile usa trajetória Terra principal', sources.motion.includes('animation-name: hero-organic-terra')],
  ['fallback mobile usa trajetória branca principal', sources.motion.includes('animation-name: hero-organic-white')],
  ...
  ['camada recovery removida', !sources.index.includes('recovery.css')],
